				...
				DATETIME_FORMATS: {
					MONTH:
						'Enero,Febrero,Marzo,Abril,Mayo,Junio,Julio,Agosto,Septiembre,Octubre,Noviembre,Diciembre'
							.split(','),
					SHORTMONTH:  'Ene,Feb,Mar,Abr,May,Jun,Jul,Ago,Sep,Oct,Nov,Dec'.split(','),
					DAY: 'Domingo,Lunes,Martes,Miércoles,Jueves,Viernes,Sábado'.split(','),
					SHORTDAY: 'Dom,Lun,Mar,Mie,Jue,Vie,Sab'.split(','),
					AMPMS: ['AM','PM'],
