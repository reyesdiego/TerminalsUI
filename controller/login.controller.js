 ...
 */
myapp.controller('loginCtrl', ['$rootScope', '$scope', '$state', 'loginService', 'authFactory', 'dialogs', '$uibModal', '$timeout', 'generalFunctions',
	function($rootScope, $scope, $state, loginService, authFactory, dialogs, $uibModal, $timeout, generalFunctions) {
		'use strict';
		...
		$scope.resetPassword = function(){
			...
			modalInstance.result.then(function(email){
				authFactory.resetPassword(email, function(data){
					if (data.status == 'OK'){
