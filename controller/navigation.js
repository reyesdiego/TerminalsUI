...
myapp.controller('navigationCtrl', ['$scope', '$rootScope', '$state', 'invoiceFactory', 'loginService', 'authFactory', function($scope, $rootScope, $state, invoiceFactory, loginService, authFactory) {
