...
myapp.controller('reporteHorariosCtrl', ['$socpe', 'reportsFactory', 'invoiceFactory', 'vouchersFactory', 'priceFactory', 'gatesFactory', 'loginService', 'dialogs', '$state', function($scope, reportsFactory, invoiceFactory, vouchersFactory, priceFactory, gatesFactory, loginService, dialogs, $state){
