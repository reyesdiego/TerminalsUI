...
class ReporteCuboCtrl {
    ...
    constructor(reportsFactory, priceFactory, loginService, dialogs) {
        ...
        this.pivotTableFields = {
            ...
            Buque: item => item.buque,
            Viaje: item => item.viaje
        };
        ...
        this.tablePivot = {
            ...
            options: {
                ...
                hiddenAttributes: ["largo", "contenedor", "tariGrupo", "buque", "viaje", "ter", "tot", "code", "a", "m", "iso3Id", "iso2Id", "mov", "tipo"],
    ...
    armarGraficoTarifas() {
        ...
        this.reportsFactory.getReporteTarifasGroupsPivot(this.model, this.tarifasGraficar).then((data) => {
            ...
            if (this.tarifasGraficar.length > 0) {
                this.pivotTableFields.Grupo = item => item.tariGrupo;
            }
