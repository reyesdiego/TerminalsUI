...
angular.module('angucomplete-alt', [] ).directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', function ($q, $parse, $http, $sce, $timeout) {
	...
	var TEXT_NORESULTS = 'No se encontraron resultados';
	...
	return {
		...
		template:
			...
			'  <span class="input-group-btn"><button class="btn btn-default" ng-click="filtrar({filtrar: filterField, contenido: \'\'}); searchStr = null"><span class="glyphicon glyphicon-remove-circle"></span></button></span>' +
			'</div>' +
