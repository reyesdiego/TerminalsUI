...
myapp.factory('controlPanelFactory', ['$http', 'formatService', 'loginService', '$q', 'HTTPCanceler', 'APP_CONFIG', 'downloadService','$filter',
    function($http, formatService, loginService, $q, HTTPCanceler, APP_CONFIG, downloadService, $filter){
        ...
        class controlPanelFactory {
            ...
            prepararDatosFacturadoDia(datosGrafico){
                ...
                datosGrafico.forEach((datosDia) => {
                    if (flagPrimero){
                        ...
                        fila[0] = $filter('date')(datosDia.date, 'EEE dd/MM/yy');
            ...
            prepararDatosGatesTurnosDia(datosGrafico){
                ...
                for (let i = 0; i <= 23; i++){
                    hora = ('0' + i);
                    matAux[i+1] = [hora.substr(hora.length-2,2), 0, 0, 0, 0, ''];
                }
                datosGrafico.forEach(datosDia => {
                    if (datosDia._id){
