  ...
  callWithJQuery(function($) {
    ...
    makeGoogleChart = function(chartType, extraOptions) {
      return function(pivotData, opts) {
        ...
        //Dibujo el grafico de manera asincrónica para que se adapte bien al tamaño de su contenedor
        setTimeout(function(){
    ...
    return $.pivotUtilities.gchart_renderers = {
      ...
      "Gráfico de dispersión": makeGoogleChart("ScatterChart")
    };
  });
